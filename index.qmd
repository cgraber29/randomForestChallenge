...
# Decision Tree Plot
p1 <- ggplot(dt_data, aes(x = Complexity)) +
  geom_line(aes(y = RMSE_Train, color = "Training"), size = 1.2) +
  geom_line(aes(y = RMSE_Test, color = "Test"), size = 1.2) +
  geom_point(aes(y = RMSE_Train, color = "Training"), size = 2) +
  geom_point(aes(y = RMSE_Test, color = "Test"), size = 2) +
...
# Random Forest Plot
p2 <- ggplot(rf_data, aes(x = Complexity)) +
  geom_line(aes(y = RMSE_Train, color = "Training"), size = 1.2) +
  geom_line(aes(y = RMSE_Test, color = "Test"), size = 1.2) +
  geom_point(aes(y = RMSE_Train, color = "Training"), size = 2) +
  geom_point(aes(y = RMSE_Test, color = "Test"), size = 2) +
...
comparison_data %>%
  kable(
    col.names = c("Model", "RMSE", "R-squared", "RMSE Improvement (%)", "R² Improvement (%)"),
    digits = 3,
  ...
  row_spec(3, background = "#d5e8d4") %>%
  row_spec(4, background = "#d5e8d4")
```
